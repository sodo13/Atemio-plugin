...
class WeatherList(Screen):       
    def __init__(self, session, Location):     
        ...
        skin = "/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Skin/WeatherList.xml"
    ...
    def go(self): 
       ...
       if Location_id and Region_id:	   
            iLocation = open('/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Config/Location_id','w')
            iLocation.write(str(Location_id))
            iLocation.close()
            iRegion = open('/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Config/Region_id','w')
...
class WeatherSearch(Screen):        
    ...
    def KeyBoard(self):
         self.session.openWithCallback(lambda x : self.VirtualKeyBoardCallback(x),VirtualKeyBoard,title = ("Enter Location:"), text = self.EnterLocation)
