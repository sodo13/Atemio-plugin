...
FontWeather("/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Font/weather.ttf", "weather", 100, False)
...
class MeteoMain(Screen):
    ...
    def __init__(self, session):
        path = "/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Skin/Weather.xml"
    ...
    def updateInfo(self):
        ...
        try:
            ...
            if dom:
                ...
                self['lab1b'].setText(_('aDreamy HD Yahoo Weather Plugin'))
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Icon/%s.png' % str(weather_data['condition']['code'])
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Icon/%s.png' % str(weather_data['forecasts'][0]['code'])
                myicon = self.checkIcon(icon)
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Icon/%s.png' % str(weather_data['forecasts'][1]['code'])
                myicon = self.checkIcon(icon)
                png = loadPic(myicon, 150, 133, 0, 0, 0, 0)
                ...
                myicon = '/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Skin/1color.png'
    ...
    def checkIcon(self, localfile):
        if fileExists(localfile):
            ...
            url = localfile.replace('/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Icon/weather', 'http://www.mysite.net/weapic/weabig')
            handler = urlopen(url)	
            if handler:
    ...
    def get_Url(self):
        ...
        url2 = '721943'
        if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Config/Location_id"):
             url2=open("/usr/lib/enigma2/python/Plugins/Extensions/aDreamyHDWeather/Config/Location_id").read()
        url = url+url2+'&u=c'
        return url
...
def Plugins(**kwargs):
        return PluginDescriptor(name = 'aDreamy HD Weather', description = 'aDreamy HD Yahoo Weather Plugin', icon = 'plugin.png', where = [PluginDescriptor.WHERE_EXTENSIONSMENU,PluginDescriptor.WHERE_PLUGINMENU], fnc = Main)
